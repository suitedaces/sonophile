...
const Header = () => {
    return (
        <div className='bg-black overflow-hidden'>
            <div className="ml-60 pt-4 md:pt-8 mb-4 md:mb-0 flex flex-col md:flex-row justify-between items-center px-4 md:px-0">
                <div className="text-xl md:text-5xl font-bold font-sans hover:shadow-lg hover:shadow-neon mb-4 md:mb-0">
                    <a href={`${CLIENT_URL}`} className="text-green-500">Sonophile</a> 👨🏽‍🎤
                </div>

                <div className='flex items-center pr-20 mt-4 md:mt-0 text-gray-200 space-x-4'>
                    ...
                    <a target='blank' className='text-sm hover:text-green-400' href="https://github.com/suitedaces/sonophile">Github</a>
                    <button onClick={logOut} className='text-gray-200 hover:text-red-600 flex items-center space-x-2'>
