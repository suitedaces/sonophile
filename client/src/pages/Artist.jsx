		...
		<div>
			{basicInfo && topTracks && albums && newAlbums && related ? 
				<div>
					...
					<div className='mt-20'>
						<h2 className='text-2xl heading mb-1 font-bold'>Top Songs by {basicInfo.name} </h2>
						...
						<div className="table justify-between w-full">
							...
							{topTracks.map(song => 
								<div className="lg:flex text-gray-400 justify-between w-full" key={song.played_at}>
									<div className="w-12/12 lg:w-7/12 truncate hover:translate-x-4 transition-transform duration-300 transform">
					...
					<div className='mt-20'>
						<h3 className='text-2xl heading mb-1 font-bold'>Latest Albums</h3>
					...
					<div className='mt-24'>
						<h3 className='text-2xl heading mb-1 font-bold'>You might also like..</h3>
						<div className="grid grid-cols-2 md:grid-cols-5">
							{
