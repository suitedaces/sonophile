    ...
    return (
        ...
        <footer className="bg-transparent ml-20 bottom-0 left-0 w-full text-center py-2">
            <span className="text-gray-100">Built with ❤️ 4 all the 
                ...
                <a target="blank" href="https://twitter.com/ishanxnagpal" className='bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 text-transparent bg-clip-text text-lg hover:text-green-400'> Ishan Nagpal</a>
            </span>
        </footer>
        </div>
    );
